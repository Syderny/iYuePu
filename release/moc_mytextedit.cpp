...
#include "../../../iYuePu/iYuePu/mytextedit.h"
...
QT_MOC_LITERAL(1, 11, 9), // "sendScale"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 5), // "scale"
QT_MOC_LITERAL(4, 28, 10), // "printScale"
QT_MOC_LITERAL(5, 39, 5) // "point"

    },
    "MyTextEdit\0sendScale\0\0scale\0printScale\0"
    "point"
};
...
void MyTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendScale((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->printScale((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTextEdit::sendScale)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTextEdit::sendScale(QString _t1)
{
